...
#define MAIN_WLAN_SSID "Samsung"  /**< Destination SSID. Change to your WIFI SSID */
#define MAIN_WLAN_AUTH M2M_WIFI_SEC_WPA_PSK /**< Security manner */
#define MAIN_WLAN_PSK "mahim123"        /**< Password for Destination SSID. Change to your password. Please dont hack my WiFi router */

/** IP address parsing. */
#define IPV4_BYTE(val, index) ((val >> (index * 8)) & 0xFF)

/** Content URI for download. */
#define MAIN_HTTP_FILE_URL "http://20.102.106.224/BlissAlarm/TestA.bin"  ///< Change me to the URL to download your OTAU binary file from!
...
#define LOCATION_TOPIC_REQ "/watch/location"
#define LOCATION_TOPIC_RES "/watch/location/mcu"
#define IPLOCATION_TOPIC_REQ "/watch/iplocation/req"
#define TIME_TOPIC_REQ "/watch/time"
#define TIME_TOPIC_RES "/watch/time/mcu"
#define TEMP_TOPIC_REQ "/watch/weather" 
#define TEMP_TOPIC_RES "/watch/weather/mcu"
#define PRAYER_TOPIC_REQ "/watch/prayertimes"
#define PRAYER_TOPIC_RES "/watch/prayertimes/mcu"
#define MOTOR_TOPIC "/watch/motor"
#define IMU_TOPIC_REQ "/watch/imu"
#define IMU_TOPIC_RES "/watch/imu/res"
 ...
 */
static const char main_mqtt_broker[] = "20.102.106.224";
